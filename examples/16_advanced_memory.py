...
# 1. Define State for the conversational task
class ChatState(State):
    request: str
    response: str = ""


# 2. Define the Agent with VectorStoreMemory
...
async def main():
    # --- Conversation 1: Agent learns a fact ---
    ...
    # --- Conversation 2: Agent processes unrelated info ---
    ...
    # --- Conversation 3: Agent semantically recalls the original fact ---
